...
<body>
	<div id="wrap">
	<div id="header"><h2>...Car Web Services</h2><h1>C.W.S.</h1></div>
	<div id="header2">
    <ul>
    ...
    <div id="makers">    <b>maker:</b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    ...
    <div id="models">
  <b>model:</b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
    <select name="model" id="model">
	<option value="" selected="selected" >All Models</option>
    </select></div>
	<div class="prices"><b>prices  (eu): &nbsp&nbsp</b>
		min
	...
	<div class="prices"><b>engine size: &nbsp</b>
		min
...
<select name="max_eng" id="max_eng">
  ...
  <option  value="4000">4000 cc</option>
	...
	<div class="prices"><b>bhp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>
	min
...
<select name="max_power" id="max_power">
  ...
  <option  value="450">450 bhp</option>
		...
		<div class="prices"><b>km runned: &nbsp</b>
		min
...
<div class="prices"><b>year:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b>
min
