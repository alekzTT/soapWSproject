...
/* get-methods.php
 *
 * A script to demonstrate interoperability of this xmlrpc implementation with
 * others. This is a client app used to query test methods from servers.
 * 
 * author: Dan Libby (dan@libby.com)
 */
...
if($server) {
   $debug = $GLOBALS[HTTP_GET_VARS][debug];
